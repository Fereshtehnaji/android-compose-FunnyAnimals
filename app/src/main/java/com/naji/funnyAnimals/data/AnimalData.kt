...
object AnimalData {
    ...
    val AnimalData = listOf(
        Animal(R.drawable.animal_white_sheep, "گوسفند",R.raw.animal_sheep_fa,R.drawable.label_animal_sheep, false),
        Animal(R.drawable.animal_cow, "گاو",R.raw.animal_cow_fa,R.drawable.label_animal_cow, false),
        Animal(R.drawable.animal_cat2, "گربه",R.raw.animal_cat_fa,  R.drawable.label_animal_cat,false),
        Animal(R.drawable.animal_mouse, "موش",R.raw.animal_cat_fa,R.drawable.label_animal_mouse, false),
        Animal(R.drawable.animal_rabbit, "خرگوش",R.raw.animal_cat_fa, R.drawable.label_animal_rabbit,false),
        Animal(R.drawable.animal_dog, "سگ",R.raw.animal_dog_fa, R.drawable.label_animal_dog,false),
        Animal(R.drawable.animal_elephant, "فیل", R.raw.animal_elephant_fa,R.drawable.label_animal_elephant,false),
        ...
        Animal(R.drawable.animal_lion, "شیر",R.raw.animal_lion_en, R.drawable.label_animal_lion,false),
        Animal(R.drawable.animal_leopard, "پلنگ",R.raw.animal_cat_fa,R.drawable.label_animal_fox, false),
        Animal(R.drawable.animal_rhino, "کرگدن", R.raw.animal_rhino_fa,R.drawable.label_animal_fox,false),
        ...
        Animal(R.drawable.animal_zebra, "گورخر",R.raw.animal_zebra_fa,R.drawable.label_animal_fox, false),
        ...
        Animal(R.drawable.animal_chameleons, "آفتاب پرست", R.raw.animal_cat_fa,R.drawable.label_animal_fox,false),
        Animal(R.drawable.animal_monkey, "میمون", R.raw.animal_monkey_fa,R.drawable.label_animal_fox,false),
        Animal(R.drawable.animal_raccoon, "راکون", R.raw.animal_monkey_fa,R.drawable.label_animal_fox,false),

        )

    val BugData = listOf(
        Animal(R.drawable.bug_antt, "مورچه",R.raw.animal_sheep_fa, R.drawable.label_bug_ant,false),
        Animal(R.drawable.bug_bee, "زنبور",R.raw.insect_bee_fa,R.drawable.label_bug_bee, false),
        Animal(R.drawable.bug_centiped, "هزارپا",R.raw.animal_cat_fa,R.drawable.label_bug_centiped, false),
        Animal(R.drawable.bug_cockroach, "سوسک",R.raw.animal_cat_fa,R.drawable.label_bug_cockroach, false),
        Animal(R.drawable.bug_cricket, "جیرجیرک",R.raw.animal_cat_fa, R.drawable.label_bug_cricket,false),
        Animal(R.drawable.bug_dragonfly, "سنجاقک",R.raw.animal_cat_fa,R.drawable.label_bug_dragonfly, false),
        Animal(R.drawable.bug_fly, "مگس",R.raw.animal_cat_fa, R.drawable.label_bug_fly,false),
        Animal(R.drawable.bug_locust, "ملخ", R.raw.animal_cat_fa,R.drawable.label_bug_locust,false),
        Animal(R.drawable.bug_silkworm, "کرم ابریشم", R.raw.animal_cat_fa,R.drawable.label_bug_silkworm,false),
        Animal(R.drawable.bug_snail, "حلزون", R.raw.animal_cat_fa,R.drawable.label_bug_snail,false),
        Animal(R.drawable.bug_spider, "عنکبوت", R.raw.animal_fox_fa,R.drawable.label_bug_spider,false),
    ...
    val AquaticData = listOf(
        ...
        Animal(R.drawable.animal_blue_unicorn, "بی نام",R.raw.animal_cat_fa,  R.drawable.label_animal_fox,false),
        Animal(R.drawable.aquatic_turtle, "لاک پشت",R.raw.animal_turtle_en,  R.drawable.label_animal_fox,false),
