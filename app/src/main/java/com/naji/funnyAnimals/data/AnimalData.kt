...
object AnimalData {
    ...
    val AnimalData = listOf(
        Animal(R.drawable.animal_sheep, "گوسفند",R.raw.animal_sheep_fa,R.drawable.label_animal_sheep, false),
        ...
        Animal(R.drawable.animal_dog, "سگ",R.raw.animal_cat_fa, R.drawable.label_animal_dog,false),
        Animal(R.drawable.animal_elephant, "فیل", R.raw.animal_elephant_fa,R.drawable.label_animal_elephant,false),
        Animal(R.drawable.animal_white_sheep, "گوسفند سفید",R.raw.animal_sheep_fa,R.drawable.label_animal_sheep, false),
