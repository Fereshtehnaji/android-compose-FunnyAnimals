...
object AnimalData {
    ...
    val AnimalData = listOf(
        Animal("sheep", "گوسفند", Language.FA.nameType, R.drawable.animal_white_sheep,
...
//Animal EN
        ...
        Animal("mouse-en", "موش", Language.EN.nameType, R.drawable.animal_mouse,
            R.raw.animal_mouse_fa, R.drawable.label_animal_mouse, TYPE.ANIMAL.nameType, false
        ),
        Animal("rabbit-en", "خرگوش", Language.EN.nameType, R.drawable.animal_rabbit,
            R.raw.animal_cat_fa, R.drawable.label_animal_rabbit, TYPE.ANIMAL.nameType, false
        ),
        ...
        Animal("rhino-en", "کرگدن", Language.EN.nameType, R.drawable.animal_rhino,
            R.raw.animal_rhino_fa, R.drawable.label_animal_fox, TYPE.ANIMAL.nameType, false
        ),
        Animal("panda-en", "پاندا", Language.EN.nameType, R.drawable.animal_panda,
            R.raw.animal_panda_fa, R.drawable.label_animal_fox, TYPE.ANIMAL.nameType, false
        ),
...
//Aquatic EN
        Animal("fish", "ماهی", Language.EN.nameType, R.drawable.aquatic_fish,
            R.raw.animal_sheep_fa, R.drawable.label_animal_fox, TYPE.AQUATIC.nameType, false
        ),
        Animal("frog", "قورباغه", Language.EN.nameType, R.drawable.aquatic_frog,
            R.raw.animal_sheep_fa, R.drawable.label_aquatic_frog, TYPE.AQUATIC.nameType, false
        ),
        Animal("dolphin", "دلفین", Language.EN.nameType, R.drawable.aquatic_dolphin,
            R.raw.animal_sheep_fa, R.drawable.label_animal_fox, TYPE.AQUATIC.nameType, false
        ),
        Animal("jellyfish", "ستاره دریایی", Language.EN.nameType, R.drawable.aquatic_jellyfish,
            R.raw.animal_sheep_fa, R.drawable.label_animal_fox, TYPE.AQUATIC.nameType, false
        ),
        Animal("walrus-en", "گراز دریایی", Language.EN.nameType, R.drawable.aquatic_walrus,
            R.raw.animal_sheep_fa, R.drawable.label_animal_fox, TYPE.AQUATIC.nameType, false
        ),
        Animal("turtle-en", "لاک پشت", Language.EN.nameType, R.drawable.aquatic_turtle,
            R.raw.animal_turtle_en, R.drawable.label_animal_fox, TYPE.AQUATIC.nameType, false
        ),
