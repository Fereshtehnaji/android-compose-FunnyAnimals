...
object AnimalData {
    ...
    val AnimalData = listOf(
        Animal(
            ...
            R.raw.animal_sheep_fa, R.drawable.label_animal_sheep, TYPE.ANIMAL, false
        ),
        Animal("cow", "گاو", Language.FA.nameType, R.drawable.animal_cow, R.raw.animal_cow_fa,
            R.drawable.label_animal_cow, TYPE.ANIMAL, false
        ),
        Animal(
            "cat", "گربه", Language.FA.nameType, R.drawable.animal_cat2,
            R.raw.animal_cat_fa, R.drawable.label_animal_cat, TYPE.ANIMAL, false
        ),
        Animal("chicken", "مرغ", Language.FA.nameType, R.drawable.animal_chicken,
            R.raw.animal_chiken_fa, R.drawable.label_animal_chicken, TYPE.ANIMAL, false
        ),
        Animal("mouse", "موش", Language.FA.nameType, R.drawable.animal_mouse, R.raw.animal_mouse_fa,
            R.drawable.label_animal_mouse, TYPE.ANIMAL, false
        ),
        Animal("rabbit", "خرگوش", Language.FA.nameType, R.drawable.animal_rabbit,
            R.raw.animal_cat_fa, R.drawable.label_animal_rabbit, TYPE.ANIMAL, false
        ),
        Animal("dog", "سگ", Language.FA.nameType, R.drawable.animal_dog,
            R.raw.animal_dog_fa, R.drawable.label_animal_dog, TYPE.ANIMAL, false
        ),
        Animal("elephant", "فیل", Language.FA.nameType, R.drawable.animal_elephant,
            R.raw.animal_elephant_fa, R.drawable.label_animal_elephant, TYPE.ANIMAL, false
        ),
        Animal("alligator", "تمساح", Language.FA.nameType, R.drawable.animal_alligator,
            R.raw.animal_cat_fa, R.drawable.label_animal_fox, TYPE.ANIMAL, false
        ),
        ...
        Animal("fox", "روباه", Language.FA.nameType, R.drawable.animal_fox,
            R.raw.animal_fox_fa, R.drawable.label_animal_fox, TYPE.ANIMAL, false
        ),
        Animal("lion", "شیر", Language.FA.nameType, R.drawable.animal_lion,
            R.raw.animal_lion_en, R.drawable.label_animal_lion, TYPE.ANIMAL, false
        ),
        ...
        Animal("rhino", "کرگدن", Language.FA.nameType, R.drawable.animal_rhino,
            R.raw.animal_rhino_fa, R.drawable.label_animal_fox, TYPE.ANIMAL, false
        ),
        Animal("panda", "پاندا", Language.FA.nameType, R.drawable.animal_panda,
            R.raw.animal_panda_fa, R.drawable.label_animal_fox, TYPE.ANIMAL, false
        ),
        Animal("tiger", "ببر", Language.FA.nameType, R.drawable.animal_tiger,
            R.raw.animal_tiger_fa, R.drawable.label_animal_tiger, TYPE.ANIMAL, false
        ),
        Animal("zebra", "گورخر", Language.FA.nameType, R.drawable.animal_zebra,
            R.raw.animal_zebra_fa, R.drawable.label_animal_fox, TYPE.ANIMAL, false
        ),
        ...
        Animal("monkey", "میمون", Language.FA.nameType, R.drawable.animal_monkey,
            R.raw.animal_monkey_fa, R.drawable.label_animal_fox, TYPE.ANIMAL, false
        ),
    ...
    val AnimalDataEn = listOf(
        Animal("sheep-en", "گوسفند", Language.EN.nameType, R.drawable.animal_white_sheep,
            R.raw.animal_sheep_en, R.drawable.label_animal_sheep, TYPE.ANIMAL, false
        ),
        Animal("cow-en", "گاو", Language.EN.nameType, R.drawable.animal_cow,
            R.raw.animal_cow_en, R.drawable.label_animal_cow, TYPE.ANIMAL, false
        ),
        Animal("cat-en", "گربه", Language.EN.nameType, R.drawable.animal_cat2,
            R.raw.animal_cat_en, R.drawable.label_animal_cat, TYPE.ANIMAL, false
        ),
        Animal(
            "chicken-en",
            "مرغ",
